...
data class Item(val uid: Int? = null, val name: String, val interactionCount: Long = 0)

internal fun Item.toEntity() = EntityItem(uid = uid, name = name, interactionCount = interactionCount)
